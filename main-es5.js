(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var AuthService = /** @class */ (function () {
                ...
                AuthService.prototype.getAuth = function (email, pass) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ContractService = /** @class */ (function () {
                function ContractService(http, auth) {
                    this.http = http;
                    this.auth = auth;
                }
                ContractService.prototype.getContracts = function (contract) {
                ...
                ContractService.prototype.createMMC = function () {
                    var formData = new FormData();
                ...
                ContractService.prototype.createMMF = function () {
                    var formData = new FormData();
                    formData.append('contract_type', 'mmforwarder');
                    formData.append('user', localStorage.getItem('email'));
                    return this.http.post('http://' + this.auth.server_ip + '/contracts/create_contract.php', formData, { responseType: 'json' });
                };
                ContractService.prototype.createTSC = function () {
                    var formData = new FormData();
                    formData.append('contract_type', 'tsclient');
                    formData.append('user', localStorage.getItem('email'));
                    return this.http.post('http://' + this.auth.server_ip + '/contracts/create_contract.php', formData, { responseType: 'json' });
                };
                ContractService.prototype.createTSF = function () {
                    var formData = new FormData();
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EditComponent = /** @class */ (function () {
                function EditComponent(activateRoute, http, auth) {
                ...
                EditComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.http.get("http://" + this.auth.server_ip + "/contracts/get_contract.php?id=" + this.id).subscribe(function (response) {
                        _this.contract_type.setValue(response['0'].contract_type);
                        if (response['0'].contract_type == 'mmforwarder' || response['0'].contract_type == 'tsforwarder') {
                            _this.client.setValue("клиентом");
                        }
                        if (response['0'].contract_type == 'mmclient' || response['0'].contract_type == 'tsclient') {
                            _this.client.setValue("перевозчиком");
                        }
                        if (response['0'].name_company != null) {
                            _this.name_company.setValue(response['0'].name_company);
                        }
                        if (response['0'].name_company_eng != null) {
                            _this.name_company_eng.setValue(response['0'].name_company_eng);
                        }
                        if (response['0'].contact_person != null) {
                            _this.contact_person.setValue(response['0'].contact_person);
                        }
                        if (response['0'].director_company != null) {
                            _this.director_company.setValue(response['0'].director_company);
                        }
                        if (response['0'].country_company != null) {
                            _this.country_company.setValue(response['0'].country_company);
                        }
                        if (response['0'].region_company != null) {
                            _this.region_company.setValue(response['0'].region_company);
                        }
                        if (response['0'].index_city_company != null) {
                            _this.index_city_company.setValue(response['0'].index_city_company);
                        }
                        if (response['0'].city_company != null) {
                            _this.city_company.setValue(response['0'].city_company);
                        }
                        if (response['0'].street_company != null) {
                            _this.street_company.setValue(response['0'].street_company);
                        }
                        if (response['0'].contact_number != null) {
                            _this.contact_number.setValue(response['0'].contact_number);
                        }
                        if (response['0'].comment_company != null) {
                            _this.comment_company.setValue(response['0'].comment_company);
                        }
                        if (response['0'].director_company_eng != null) {
                            _this.director_company_eng.setValue(response['0'].director_company_eng);
                        }
                        if (response['0'].country_company_eng != null) {
                            _this.country_company_eng.setValue(response['0'].country_company_eng);
                        }
                        if (response['0'].region_company_eng != null) {
                            _this.region_company_eng.setValue(response['0'].region_company_eng);
                        }
                        if (response['0'].index_city_company_eng != null) {
                            _this.index_city_company_eng.setValue(response['0'].index_city_company_eng);
                        }
                        if (response['0'].city_company_eng != null) {
                            _this.city_company_eng.setValue(response['0'].city_company_eng);
                        }
                        if (response['0'].street_company_eng != null) {
                            _this.street_company_eng.setValue(response['0'].street_company_eng);
                        }
                        if (response['0'].contact_person_eng != null) {
                            _this.contact_person_eng.setValue(response['0'].contact_person_eng);
                        }
                        if (response['0'].contact_number_eng != null) {
                            _this.contact_number_eng.setValue(response['0'].contact_number_eng);
                        }
                        console.log(_this.contract_type.value);
                        if (_this.contract_type.value == 'mmforwarder' || _this.contract_type.value == 'tsforwarder') {
                            //////////////////////////////Material Autocomlete OnInit 
                            _this.name_company.valueChanges
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                                _this.filteredname_company = [];
                                _this.isLoadingname_company = true;
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.auth.server_ip + "/search/search_companies.php?company=" + value)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                                _this.isLoadingname_company = false;
                            })); }))
                                ...
                                if (data['company'] == null) {
                                    ...
                                    _this.filteredname_company = data["company"];
                                }
                            });
                            //////////////////////////////Material Autocomlete OnInit 
                        }
                            ...
                            _this.name_company.valueChanges
                                ...
                                _this.filteredname_company = [];
                                _this.isLoadingname_company = true;
                            }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.auth.server_ip + "/search/search_carrier.php?carrier=" + value)
                                .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                                _this.isLoadingname_company = false;
                            })); }))
                                .subscribe(function (data) {
                                if (data['carrier'] == null) {
                                    ...
                                    _this.filteredname_company = data["carrier"];
                                }
                            });
                            //////////////////////////////Material Autocomlete OnInit Carrier
                        }
                    });
                    this.http.get("http://" + this.auth.server_ip + "/contracts/get_contract_document.php?id=" + this.id).subscribe(function (response) {
                        _this.contract_number.setValue(response['0'].contract_number);
                        _this.contract_date.setValue(response['0'].contract_date);
                        _this.contract_currency.setValue(response['0'].contract_currency);
                        _this.contract_amount.setValue(response['0'].contract_amount);
                        _this.contract_comment.setValue(response['0'].contract_comment);
                        _this.path.setValue(response['0'].contract_path);
                ...
                EditComponent.prototype.selectedname_company = function (item) {
                    this.name_company.setValue(item.option.value);
                };
                EditComponent.prototype.SaveCompany = function () {
                    var formData = new FormData();
                    ...
                    return this.http.post('http://' + this.auth.server_ip + '/contracts/edit_contract.php', formData, { responseType: 'json' })
                        .subscribe(function (SaveContractResponse) {
                        console.log(SaveContractResponse);
                    });
                };
                EditComponent.prototype.SaveContract = function () {
                    var _this = this;
                    ...
                    return this.http.post('http://' + this.auth.server_ip + '/contracts/set_contract.php', formDataContract, { responseType: 'json' })
                        .subscribe(function (SaveContractResponse) {
                        console.log(SaveContractResponse);
                        _this.path.setValue(SaveContractResponse['path']);
                    });
                };
                EditComponent.prototype.fileProgress = function (fileInput) {
                ...
                EditComponent.prototype.downContract = function () {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MmclientComponent = /** @class */ (function () {
                function MmclientComponent(contract, route) {
                    this.contract = contract;
                    this.route = route;
                    this.faEdit = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faEdit"];
                    this.faPlusSquare = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faPlusSquare"];
                }
                MmclientComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.contract.getContracts('mmclient').subscribe(function (response) {
                        _this.MMClient = response['contract'];
                        console.log(_this.MMClient);
                    });
                };
                MmclientComponent.prototype.createMMC = function () {
                    var _this = this;
                    this.contract.createMMC().subscribe(function (response) {
                        _this.route.navigate(['/contracts/edit/' + response['id']]);
                    });
                };
                return MmclientComponent;
            }());
            MmclientComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var MmforwarderComponent = /** @class */ (function () {
                function MmforwarderComponent(contract, route, http) {
                    this.contract = contract;
                    this.route = route;
                    this.http = http;
                    this.faEdit = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faEdit"];
                ...
                MmforwarderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.contract.getContracts('mmforwarder').subscribe(function (response) {
                        _this.MMForwarder = response['contract'];
                    });
                };
                MmforwarderComponent.prototype.createMMF = function () {
                    var _this = this;
                    this.contract.createMMF().subscribe(function (response) {
                        _this.route.navigate(['/contracts/edit/' + response['id']]);
                    });
                };
                return MmforwarderComponent;
            }());
            MmforwarderComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _contract_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../contract.service */ "./src/app/contracts/contract.service.ts");
            var TsclientComponent = /** @class */ (function () {
                function TsclientComponent(contract, route) {
                    this.contract = contract;
                    this.route = route;
                    this.faEdit = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faEdit"];
                    this.faPlusSquare = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faPlusSquare"];
                }
                TsclientComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.contract.getContracts('tsclient').subscribe(function (response) {
                        _this.TSClient = response['contract'];
                    });
                };
                TsclientComponent.prototype.createTSC = function () {
                    var _this = this;
                    this.contract.createTSC().subscribe(function (response) {
                        _this.route.navigate(['/contracts/edit/' + response['id']]);
                    });
                };
                return TsclientComponent;
            }());
            TsclientComponent.ctorParameters = function () { return [
                { type: _contract_service__WEBPACK_IMPORTED_MODULE_4__["ContractService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            /* harmony import */ var _angular_router__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @angular/router */ "./node_modules/@angular/router/fesm2015/router.js");
            /* harmony import */ var _contract_service__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ../contract.service */ "./src/app/contracts/contract.service.ts");
            var TsforwarderComponent = /** @class */ (function () {
                function TsforwarderComponent(contract, route) {
                    this.contract = contract;
                    this.route = route;
                    this.faEdit = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faEdit"];
                    this.faPlusSquare = _fortawesome_free_solid_svg_icons__WEBPACK_IMPORTED_MODULE_2__["faPlusSquare"];
                }
                TsforwarderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.contract.getContracts('tsforwarder').subscribe(function (response) {
                        _this.TSForwarder = response['contract'];
                    });
                };
                TsforwarderComponent.prototype.createTSF = function () {
                    var _this = this;
                    this.contract.createTSF().subscribe(function (response) {
                        _this.route.navigate(['/contracts/edit/' + response['id']]);
                    });
                };
                return TsforwarderComponent;
            }());
            TsforwarderComponent.ctorParameters = function () { return [
                { type: _contract_service__WEBPACK_IMPORTED_MODULE_4__["ContractService"] },
                { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] }
            ]; };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardComponent = /** @class */ (function () {
                function DashboardComponent(router, dashboard) {
                    this.router = router;
                ...
                DashboardComponent.prototype.ngOnInit = function () {
                    ...
                    if (localStorage.getItem('role') == null) {
                        ...
                        this.dashboard.getLogistics(this.email).subscribe(function (ResponseLogistics) {
                            _this.Logistics = ResponseLogistics['logistic'];
                            console.log(_this.Logistics);
                        });
                    }
                };
                DashboardComponent.prototype.createShipping = function () {
                    var _this = this;
                    this.dashboard.createShipping(localStorage.getItem('email')).subscribe(function (response) {
                        console.log(response);
                        _this.router.navigate(['/shipping/' + response['id'] + '/general']);
                    });
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var LoginComponent = /** @class */ (function () {
                ...
                LoginComponent.prototype.email_change = function () {
                };
                LoginComponent.prototype.password_change = function () {
                };
                LoginComponent.prototype.onSubmit = function () {
                    var _this = this;
                    this.authservice.getAuth(this.user.email, this.user.password).subscribe(function (Users) {
                        _this.user = Users;
                        if (_this.user.role) {
                            localStorage.setItem('email', _this.user.email);
                            localStorage.setItem('name', _this.user.name);
                            localStorage.setItem('role', _this.user.role);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DashboardService = /** @class */ (function () {
                function DashboardService(http, auth) {
                    this.http = http;
                    this.auth = auth;
                }
                DashboardService.prototype.getLogistics = function (email) {
                    var formData = new FormData();
                    formData.append('email', String(email));
                    return this.http.post('http://' + this.auth.server_ip + '/dashboard/logistics.php', formData, { responseType: 'json' });
                };
                DashboardService.prototype.createShipping = function (email) {
                    var formData = new FormData();
                    formData.append('email', String(email));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CmrComponent = /** @class */ (function () {
                function CmrComponent(shipservice, activateRoute, http, auth) {
                ...
                CmrComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.shipservice.getTrucks().subscribe(function (response) {
                        _this.tractor = response['tractor'];
                        _this.trailer = response['trailer'];
                        _this.truck_id = response['trac_id'];
                        _this.driver_first_name = response['driver_first_name'];
                        _this.driver_last_name = response['driver_last_name'];
                        _this.name_company = response['name_company'];
                        _this.cmr_number = response['cmr_number'];
                        _this.cmr_date = response['cmr_date'];
                        _this.path = response['path'];
                        for (var i = 0; i < response['tractor'].length; i++) {
                ...
                CmrComponent.prototype.onSubmit = function (index) {
                ...
                CmrComponent.prototype.fileProgress = function (fileInput) {
                    this.fileData = fileInput.target.files[0];
                };
                CmrComponent.prototype.onSubmitFile = function (index) {
                    var _this = this;
                    var formData = new FormData();
                    ...
                    this.http.post('http://' + this.auth.server_ip + '/cmr/upload_cmr_file.php', formData)
                        .subscribe(function (res) {
                        console.log(res);
                        _this.shipservice.getTrucks().subscribe(function (response) {
                            _this.path = response['path'];
                            for (var i = 0; i < response['tractor'].length; i++) {
                                if (response['path'][i] != undefined && response['path'][i] != null && response['path'][i] != '') {
                                    _this.loaded[i] = true;
                ...
                CmrComponent.prototype.downCMR = function (i) {
                    console.log(i);
            ...
            CmrComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ClientOrderComponent = /** @class */ (function () {
                function ClientOrderComponent(shipservice, activateRoute, http, auth) {
                    this.shipservice = shipservice;
                    this.activateRoute = activateRoute;
                    this.http = http;
                    this.auth = auth;
                ...
                ClientOrderComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.shipservice.getAgreementClient().subscribe(function (response) {
                        _this.client_name = response['response']['name_company'];
                        _this.client_id = response['response']['company_id'];
                        _this.contracts_number_client = response['response']['contracts_number_client'];
                        _this.contracts_date_client = response['response']['contracts_date_client'];
                        _this.contracts_ids_client = response['response']['contracts_ids_client'];
                        for (var h = 0; h < _this.contracts_number_client.length; h++) {
                            if (h == _this.contracts_number_client.length - 1) {
                                _this.contract_number_client = _this.contracts_number_client[h];
                                _this.contract_date_client = response['response']['contracts_date_client'][h];
                                _this.contract_id_client = response['response']['contracts_id_client'][h];
                            }
                        }
                        if (response['response']['order_number_client'] != null) {
                            _this.order_number_client = response['response'].order_number_client;
                            _this.order_date_client = response['response'].order_date_client;
                            if (response['response'].order_path_client != undefined && response['response'].order_path_client != '') {
                                _this.order_path_client = response['response'].order_path_client;
                                _this.loadedClient = true;
                            }
                        }
                    });
                };
                ClientOrderComponent.prototype.fileProgress = function (fileInput) {
                    this.fileData = fileInput.target.files[0];
                };
                ClientOrderComponent.prototype.selectclient = function (index) {
                    for (var i = 0; i < this.contract_number_client.length; i++) {
                        if (this.contracts_number_client[i] == index) {
                            this.contract_id_client = i;
                        }
                    }
                };
                ClientOrderComponent.prototype.onSubmitClient = function () {
                    var formDataClient = new FormData();
                ...
                ClientOrderComponent.prototype.onSubmitClientFile = function () {
                    var _this = this;
                    var formDataClient = new FormData();
                    ...
                    this.http.post('http://' + this.auth.server_ip + '/documents/upload_order_client_file.php', formDataClient)
                        .subscribe(function (res) {
                        console.log(res);
                        _this.shipservice.getAgreementClient().subscribe(function (response) {
                            for (var i = 0; i < response['response'].contracts_number_client.length; i++) {
                ...
                ClientOrderComponent.prototype.downOrderClient = function () {
            ...
            ClientOrderComponent.ctorParameters = function () { return [
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var DocumentComponent = /** @class */ (function () {
                function DocumentComponent(shipservice, activateRoute, http, auth) {
                    this.shipservice = shipservice;
                    this.activateRoute = activateRoute;
                    this.http = http;
                    this.auth = auth;
                ...
                DocumentComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.shipservice.getAgreement().subscribe(function (response) {
                        _this.Carriers = response['response']['name'];
                        _this.Carriers_id = response['response']['id'];
                        for (var i = 0; i < response['response'].contract_number.length; i++) {
                            _this.contract_numbers[i] = response["response"].contract_number[i];
                            _this.contract_dates[i] = response["response"].contract_date[i];
                            _this.contract_id[i] = response["response"].contract_id[i];
                            _this.order_number[i] = response["response"].orders_number[i];
                            _this.order_date[i] = response["response"].orders_date[i];
                            ...
                            if (response["response"].order_path[i] != undefined && response["response"].order_path[i] != '') {
                                ...
                                _this.order_path[i] = response["response"].order_path[i];
                                _this.loaded[i] = true;
                            }
                        }
                        console.log(_this.loaded);
                        for (var i = 0; i < _this.contract_numbers.length; i++) {
                            for (var j = 0; j < _this.contract_numbers[i].length; j++) {
                                if (j == _this.contract_numbers[i].length - 1) {
                                    _this.contract_number[i] = _this.contract_numbers[i][j];
                                    _this.contract_date[i] = response["response"].contract_date[i][j];
                                    _this.indx_number = j;
                                }
                            }
                        }
                ...
                /////////////////////////////////////Order	
                DocumentComponent.prototype.downOrder = function (i) {
                    console.log(i);
                ...
                DocumentComponent.prototype.selectcarrier = function (indx, i) {
                    for (var j = 0; j < this.contract_numbers.length; j++) {
                        for (var k = 0; k < this.contract_numbers[j].length; k++) {
                ...
                DocumentComponent.prototype.fileProgress = function (fileInput) {
                    this.fileData = fileInput.target.files[0];
                };
                DocumentComponent.prototype.onSubmit = function (index) {
                    var formData = new FormData();
                    formData.append('id', String(this.shipservice.id));
                ...
                DocumentComponent.prototype.onSubmitFile = function (index) {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('file', this.fileData);
                    formData.append('id', String(this.shipservice.id));
                    ...
                    this.http.post('http://' + this.auth.server_ip + '/documents/upload_order_file.php', formData)
                        .subscribe(function (res) {
                        console.log(res);
                        _this.shipservice.getAgreement().subscribe(function (response) {
                            for (var i = 0; i < response['response'].contract_number.length; i++) {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var GeneralComponent = /** @class */ (function () {
                function GeneralComponent(activateRoute, authservice, http, formBuilder, shipservice) {
                    this.activateRoute = activateRoute;
                    this.authservice = authservice;
                    this.http = http;
                ...
                GeneralComponent.prototype.selectedcountry_begin = function (item) {
                    this.country_begin.setValue(item.option.value);
                };
                GeneralComponent.prototype.selectedcountry_end = function (item) {
                    this.country_end.setValue(item.option.value);
                };
                GeneralComponent.prototype.selectedname_company = function (item) {
                    this.name_company.setValue(item.option.value);
                };
                //////////////////////////////Material Autocomlete
                GeneralComponent.prototype.ngOnInit = function () {
                    ...
                    //////////////////////////////ngOnInit
                    this.shipservice.getShipping(this.shipservice.id).subscribe(function (shipping) {
                        _this.Auto.setValue(Boolean(Number(shipping['type_transportation'])));
                        _this.service.setValue(shipping['load_transportation']);
                        _this.incoterm.setValue(shipping['incoterm']);
                        _this.country_begin.setValue(shipping['from_country']);
                        _this.country_end.setValue(shipping['to_country']);
                        _this.city_begin.setValue(shipping['from_city']);
                        _this.city_end.setValue(shipping['to_city']);
                        _this.status.setValue(shipping['status']);
                        _this.comments.setValue(shipping['comments']);
                        _this.rate_for_client.setValue(shipping['rate_for_client']);
                        _this.rate_for_client_currency.setValue(shipping['rate_for_client_currency']);
                        _this.name_company.setValue(shipping['name_company']);
                    });
                    //////////////////////////////ngOnInit
                    //////////////////////////////Material Autocomlete OnInit
                    this.name_company.valueChanges
                        ...
                        _this.filteredname_company = [];
                        _this.isLoadingname_company = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_companies_contract.php?company=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingname_company = false;
                    })); }))
                        .subscribe(function (data) {
                    ...
                    this.country_begin.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredcountry_begin = [];
                        _this.isLoadingcountry_begin = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_countries.php?countries=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingcountry_begin = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['countries'] == null) {
                            ...
                            _this.filteredcountry_begin = data["countries"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit
                    //////////////////////////////Material Autocomlete OnInit
                    this.country_end.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredcountry_end = [];
                        _this.isLoadingcountry_end = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_countries.php?countries=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingcountry_end = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['countries'] == null) {
                            _this.filteredcountry_end = [];
                            ...
                            _this.filteredcountry_end = data["countries"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit
                    this.Auto.valueChanges.subscribe(function (value) {
                    });
                    ///////////////////////////////ValueChanges
                    this.city_begin.valueChanges.subscribe(function (value) {
                        console.log(value);
                    });
                    this.city_end.valueChanges.subscribe(function (value) {
                        console.log(value);
                    });
                    this.incoterm.valueChanges.subscribe(function (value) {
                        console.log(value);
                        if (value == 'CIP') {
                            _this.incoterm_description_state = true;
                            _this.incoterm_description_text = _this.incoterms_description[0];
                        }
                        if (value == 'DAP') {
                            _this.incoterm_description_state = true;
                            _this.incoterm_description_text = _this.incoterms_description[1];
                        }
                        if (value == 'FCA') {
                            _this.incoterm_description_state = true;
                            _this.incoterm_description_text = _this.incoterms_description[2];
                        }
                        if (value == 'EXW') {
                            _this.incoterm_description_state = true;
                            _this.incoterm_description_text = _this.incoterms_description[3];
                        }
                    });
                    ///////////////////////////////ValueChanges
                };
                GeneralComponent.prototype.Autoswitch = function () {
                    this.Auto.setValue(true);
                };
                GeneralComponent.prototype.Aviaswitch = function () {
                    this.Auto.setValue(false);
                };
                GeneralComponent.prototype.SaveGeneral = function () {
                    var _this = this;
                    ...
                    formData.append('name_company', String(this.name_company.value));
                    return this.http.post('http://' + this.authservice.server_ip + '/shipping/set_shipping.php', formData, { responseType: 'json' }).subscribe(function (response) {
                        console.log(response);
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var NotesComponent = /** @class */ (function () {
                function NotesComponent(shipservice, activateRoute) {
                    this.shipservice = shipservice;
                    this.activateRoute = activateRoute;
                ...
                NotesComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.shipservice.getNotes(this.shipservice.id).subscribe(function (Note) {
                        console.log(Note['response'].length);
                        _this.notesTable = Note['response'];
                    });
                };
                NotesComponent.prototype.saveNotes = function () {
                    ...
                    this.shipservice.saveNote(this.shipservice.id, email, this.notes.value, toBaseDate).subscribe(function (response) {
                        console.log(response);
                        _this.shipservice.getNotes(_this.shipservice.id).subscribe(function (Note) {
                            _this.notesTable = Note['response'];
                        });
                    });
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var PaymentComponent = /** @class */ (function () {
                function PaymentComponent(shipservice, activateRoute, http, authservice) {
                    this.shipservice = shipservice;
                    this.activateRoute = activateRoute;
                    this.http = http;
                    this.authservice = authservice;
                ...
                PaymentComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    this.shipservice.getIOs().subscribe(function (response) {
                        _this.Payments = response['response'];
                    });
                    this.shipservice.getIIs().subscribe(function (response) {
                        _this.Payments_II = response['response'];
                        console.log(response);
                    });
                };
                PaymentComponent.prototype.SaveIO = function () {
                    var _this = this;
                    var formData = new FormData();
                    ...
                    this.http.post('http://' + this.authservice.server_ip + '/payments/set_io.php', formData)
                        ...
                        _this.shipservice.getIOs().subscribe(function (response) {
                            _this.Payments = response['response'];
                            _this.name_payment_io.setValue("");
                            _this.rate_payment_io.setValue("");
                            _this.currency_payment_io.setValue("");
                            _this.invoice_number_io.setValue("");
                            _this.date_payment_io.setValue("");
                            _this.status_payment_io.setValue("");
                        });
                    });
                };
                PaymentComponent.prototype.edit_IO = function (index) {
                    this.IO_edit = true;
                ...
                PaymentComponent.prototype.cancel_IO = function () {
                ...
                PaymentComponent.prototype.Editing_IO = function () {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('logistics_id', String(this.shipservice.id));
                ...
                PaymentComponent.prototype.Delete_IO = function (index) {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('logistics_id', String(this.shipservice.id));
                ...
                PaymentComponent.prototype.SaveII = function () {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('logistics_id', String(this.shipservice.id));
                    ...
                    this.http.post('http://' + this.authservice.server_ip + '/payments/set_ii.php', formData)
                        .subscribe(function (response) {
                        _this.shipservice.getIIs().subscribe(function (response) {
                            _this.Payments_II = response['response'];
                            _this.name_payment_ii.setValue("");
                            _this.rate_payment_ii.setValue("");
                            _this.currency_payment_ii.setValue("");
                            _this.invoice_number_ii.setValue("");
                            _this.date_payment_ii.setValue("");
                            _this.status_payment_ii.setValue("");
                        });
                    });
                };
                PaymentComponent.prototype.edit_II = function (index) {
                    this.II_edit = true;
                ...
                PaymentComponent.prototype.cancel_II = function () {
                ...
                PaymentComponent.prototype.Editing_II = function () {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('logistics_id', String(this.shipservice.id));
                ...
                PaymentComponent.prototype.Delete_II = function (index) {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('logistics_id', String(this.shipservice.id));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShippingService = /** @class */ (function () {
                function ShippingService(http, auth) {
                    this.http = http;
                    this.auth = auth;
                }
                ShippingService.prototype.getShipping = function (id) {
                    return this.http.get('http://' + this.auth.server_ip + '/shipping/get_shipping.php?id=' + id);
                };
                ShippingService.prototype.getTransport = function () {
                    return this.http.get('http://' + this.auth.server_ip + '/shipping/get_Transport.php?id=' + this.id);
                };
                ShippingService.prototype.getNotes = function (id) {
                    return this.http.get('http://' + this.auth.server_ip + '/notes/get_notes.php?id=' + id);
                };
                ShippingService.prototype.saveNote = function (id, email, note, date) {
                    var formData = new FormData();
                ...
                ShippingService.prototype.getCompany = function (name_company) {
                    return this.http.get('http://' + this.auth.server_ip + '/search/get_company.php?name_company=' + name_company);
                };
                ShippingService.prototype.getTruck = function (tractor) {
                    return this.http.get('http://' + this.auth.server_ip + '/search/get_truck.php?tractor=' + tractor);
                };
                ShippingService.prototype.getDriver = function (driver) {
                    return this.http.get('http://' + this.auth.server_ip + '/search/get_driver.php?driver=' + driver);
                };
                ShippingService.prototype.saveTransport = function (searchTractor, trailer, searchCountry_truck, mark_truck, driver_seria_pass, searchDriver_number_pass, driver_first_name, driver_last_name, searchDriver_country, driver_text, searchCarrier_name, rate, rate_currency) {
                    var formData = new FormData();
                    formData.append('id', String(this.id));
                ...
                ShippingService.prototype.editTransport = function (transport_id, searchTractor, trailer, searchCountry_truck, mark_truck, driver_seria_pass, searchDriver_number_pass, driver_first_name, driver_last_name, searchDriver_country, driver_text, searchCarrier_name, rate, rate_currency) {
                    var formData = new FormData();
                    formData.append('id', String(this.id));
                ...
                ShippingService.prototype.deleteTransport = function (transport_id) {
                    var formData = new FormData();
                    formData.append('id', String(this.id));
                    formData.append('transport_id', String(transport_id));
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var ShippingComponent = /** @class */ (function () {
                function ShippingComponent(activateRoute, shippingService) {
                    this.activateRoute = activateRoute;
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var TransportComponent = /** @class */ (function () {
                function TransportComponent(shipservice, activateRoute, http, authservice) {
                    this.shipservice = shipservice;
                    this.activateRoute = activateRoute;
                    this.http = http;
                    this.authservice = authservice;
                ...
                TransportComponent.prototype.selectedTractor = function (item) {
                    var _this = this;
                    this.shipservice.getTruck(item.option.value).subscribe(function (Truck) {
                        console.log(Truck);
                        _this.trailer.setValue(Truck['trailer']);
                        _this.searchCountry_truck.setValue(Truck['country']);
                        _this.mark_truck.setValue(Truck['mark']);
                    });
                };
                TransportComponent.prototype.selectedCountry_truck = function (item) {
                    this.searchCountry_truck.setValue(item.option.value);
                };
                TransportComponent.prototype.selectedDriver_number_pass = function (item) {
                    var _this = this;
                    this.shipservice.getDriver(item.option.value).subscribe(function (Driver) {
                        console.log(Driver);
                        _this.driver_seria_pass.setValue(Driver['driver_seria_pass']);
                        _this.driver_first_name.setValue(Driver['driver_first_name']);
                        _this.driver_last_name.setValue(Driver['driver_last_name']);
                        _this.searchDriver_country.setValue(Driver['driver_country']);
                        _this.driver_text.setValue(Driver['driver_text']);
                    });
                };
                TransportComponent.prototype.selectedDriver_country = function (item) {
                    this.searchDriver_country.setValue(item.option.value);
                };
                TransportComponent.prototype.selectedCarrier_name = function (item) {
                    this.searchCarrier_name.setValue(item.option.value);
                };
                TransportComponent.prototype.ngOnInit = function () {
                    var _this = this;
                    ///////////////////////////////////////ngOnInit
                    this.shipservice.getTransport().subscribe(function (response) {
                        _this.Transports = response[0];
                        _this.total_rate = response['total_rate'];
                        _this.total_currency = response['total_currency'];
                        _this.count_carriers = response['count_carriers'];
                        var formData = new FormData();
                        formData.append('id', String(_this.shipservice.id));
                        return _this.http.post('http://' + _this.authservice.server_ip + '/status/getStat_Us.php', formData, { responseType: 'json' }).subscribe(function (response) {
                            _this.Stat_Us = response["duo"];
                            console.log(_this.Stat_Us);
                            _this.Transports + _this.Stat_Us;
                            console.log(_this.Transports);
                        });
                    });
                    ///////////////////////////////////////ngOnInit
                    ///////////////////////////////////////valuechanges
                    this.searchDriver_country.valueChanges.subscribe(function (value) {
                    ...
                    this.searchCarrier_name.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredCarrier_name = [];
                        _this.isLoadingCarrier_name = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_carrier_contract.php?company=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingCarrier_name = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['company'] == null) {
                            _this.filteredCarrier_name = [];
                            ...
                            _this.filteredCarrier_name = data["company"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit Carrier
                    ...
                    this.searchDriver_country.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredDriver_country = [];
                        _this.isLoadingDriver_country = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_countries.php?countries=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingDriver_country = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['countries'] == null) {
                            _this.filteredDriver_country = [];
                            ...
                            _this.filteredDriver_country = data["countries"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit Driver country
                    ...
                    this.searchDriver_number_pass.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredDriver_number_pass = [];
                        _this.isLoadingDriver_number_pass = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_driver.php?driver=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingDriver_number_pass = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['driver'] == null) {
                            _this.filteredDriver_number_pass = [];
                            ...
                            _this.filteredDriver_number_pass = data["driver"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit Driver
                    ...
                    this.searchCountry_truck.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredCountry_truck = [];
                        _this.isLoadingCountry_truck = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_countries.php?countries=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingCountry_truck = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['countries'] == null) {
                            _this.filteredCountry_truck = [];
                            ...
                            _this.filteredCountry_truck = data["countries"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit truck country
                    ...
                    this.searchTractor.valueChanges
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["debounceTime"])(500), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function () {
                        _this.filteredTractor = [];
                        _this.isLoadingTractor = true;
                    }), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["switchMap"])(function (value) { return _this.http.get("http://" + _this.authservice.server_ip + "/search/search_truck.php?tractor=" + value)
                        .pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["finalize"])(function () {
                        _this.isLoadingTractor = false;
                    })); }))
                        .subscribe(function (data) {
                        if (data['tractor'] == null) {
                            ...
                            _this.filteredTractor = data["tractor"];
                        }
                    });
                    //////////////////////////////Material Autocomlete OnInit Truck
                };
                TransportComponent.prototype.SaveTransport = function () {
                    var _this = this;
                    this.disable = true;
                    this.shipservice.saveTransport(this.searchTractor.value, this.trailer.value, this.searchCountry_truck.value, this.mark_truck.value, this.driver_seria_pass.value, this.searchDriver_number_pass.value, this.driver_first_name.value, this.driver_last_name.value, this.searchDriver_country.value, this.driver_text.value, this.searchCarrier_name.value, this.rate.value, this.rate_currency.value)
                        .subscribe(function (response) {
                        console.log(response);
                        _this.shipservice.getTransport().subscribe(function (response) {
                            _this.Transports = response[0];
                            _this.total_rate = response['total_rate'];
                            _this.total_currency = response['total_currency'];
                            _this.count_carriers = response['count_carriers'];
                ...
                TransportComponent.prototype.edit_transport = function (index) {
                    var _this = this;
                    this.editing = true;
                    ...
                    return this.http.post('http://' + this.authservice.server_ip + '/status/getStatus.php', formData, { responseType: 'json' }).subscribe(function (response) {
                        _this.Statuses = response["response"];
                    });
                };
                TransportComponent.prototype.CancelEditing = function () {
                    this.searchTractor.setValue("");
                    this.trailer.setValue("");
                    this.searchCountry_truck.setValue("");
                    this.mark_truck.setValue("");
                ...
                TransportComponent.prototype.EditTransport = function () {
                    var _this = this;
                ...
                TransportComponent.prototype.delete = function (index) {
                    var _this = this;
                    var indx = this.Transports[index]['id'];
                    this.shipservice.deleteTransport((indx)).subscribe(function (deleted) {
                        console.log(deleted);
                        _this.shipservice.getTransport().subscribe(function (response) {
                            _this.Transports = response[0];
                            _this.total_rate = response['total_rate'];
                ...
                TransportComponent.prototype.addStatus = function () {
                    var _this = this;
                    var formData = new FormData();
                    formData.append('id', String(this.shipservice.id));
                    formData.append('transport_id', String(this.truck_id));
                    ...
                    return this.http.post('http://' + this.authservice.server_ip + '/status/addStatus.php', formData, { responseType: 'json' }).subscribe(function (value) {
                        _this.status.setValue('');
                        _this.date.setValue('');
                        var formData = new FormData();
                        formData.append('id', String(_this.shipservice.id));
                        formData.append('transport_id', String(_this.truck_id));
                        return _this.http.post('http://' + _this.authservice.server_ip + '/status/getStatus.php', formData, { responseType: 'json' }).subscribe(function (response) {
                            _this.Statuses = response["response"];
                            var formData = new FormData();
                            formData.append('id', String(_this.shipservice.id));
                            return _this.http.post('http://' + _this.authservice.server_ip + '/status/getStat_Us.php', formData, { responseType: 'json' }).subscribe(function (response) {
